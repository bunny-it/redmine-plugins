...
# Only apply patches if the classes exist
if defined?(Contact)
  ...
  Rails.logger.info "Contact model patch applied successfully"
else
  Rails.logger.warn "Contact model not found, validation patch skipped"
end
...
if defined?(Address)
  ...
  Rails.logger.info "Address model patch applied successfully"
else
  Rails.logger.warn "Address model not found, display patch skipped"
end
