...
class DealTest < ActiveSupport::TestCase
  ...
  def test_price_to_s_with_custom_settings
    Redmineup::Settings.apply = { 'thousands_delimiter' => ' ', 'decimal_separator' => '.' }
  ...
  def test_price_with_big_value
    ...
    assert_equal '9 999 999 999 999.00 ₽', Deal.find(5).price_to_s
  ensure
