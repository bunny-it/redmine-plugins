...
module RedmineContacts
  module Helper
    module CrmCalendarHelper
      ...
      def deal_status_tag(deal_status, classes="")
        content_tag(:span, deal_status.name, class: "status-badge #{classes}",
            style: "color:#{deal_status.color_name};border: 1px solid #{deal_status.color_name};") unless deal_status.blank?
      end
    end
  end
end
